...
from .models import CustomUser,Events,Sessions,Speakers
...
def edit_event(request, pk):
    ...
    # Use the serializer for updating the instance
    serializer = EventSerializerAdd(event, data=request.data)
    if serializer.is_valid():
        serializer.save()
